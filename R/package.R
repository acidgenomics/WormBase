...
#' @keywords internal
#'
#' @importFrom basejump CharacterList DataFrame DataFrameList List abort
#'   aggregate alert cacheURL camelCase do.call formula head import lapply
#'   makeNames packageName pasteURL rbindToDataFrame removeNA sanitizeNA split
#'   str_extract str_extract_all str_match str_match_all str_sub t tail transmit
#'   unlist unsplit untar
