...
#' @importFrom basejump DataFrame DataFrameList aggregate alert cacheURL
#'   camelCase formula head import makeNames pasteURL rbindlist removeNA
#'   sanitizeNA split t tail transmit unlist unsplit untar
