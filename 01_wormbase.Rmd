...
geneIDs <- wormbaseAnnotationFile("geneIDs") %>%
    read_csv(col_names = c("X1", "gene", "name", "sequence", "status"),
             na = "") %>% select(-X1)
saveDataRaw(geneIDs)
```
...
# [fix] Chain method for suppressWarnings?
