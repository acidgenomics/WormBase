...
```{r render}
rmarkdown::render("data-raw/01_gene.Rmd", output_format = "all")
rmarkdown::render("data-raw/02_rnai.Rmd", output_format = "all")
rmarkdown::render("data-raw/03_eggnog.Rmd", output_format = "all")
```

```{r annotation}
data(gene, rnai, eggnog)
