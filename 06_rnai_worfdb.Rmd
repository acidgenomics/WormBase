...
source("setup.R")
loadRemoteData("http://worminfo.steinbaugh.com/worfdbHTML.rda")
loadRemoteData("http://worminfo.steinbaugh.com/worfdbHTMLRemap.rda")
...
# FIXME Add step for filtering bad sequence?
